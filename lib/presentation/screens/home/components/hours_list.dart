                     ...
                     Card(
                      ...
                      child:  Container(
                        ...
                        decoration: BoxDecoration(
                            color: provider.compareIndex(index)? Colors.blue: Colors.white70,
                            borderRadius: BorderRadius.circular(50)),
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style:  TextStyle(
                                color:provider.compareIndex(index) ? Colors.white :Colors.grey ,
                            ...
                            Text(
                              '${provider
                                  .weatherDataModel!.days![0].hours![index].temp
                                  .toInt()}\u00B0',
                              style:  TextStyle(
                                  color:provider.compareIndex(index) ? Colors.white :Colors.grey ,
                                  fontWeight: FontWeight.bold,
